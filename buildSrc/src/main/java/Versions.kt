...
object Versions {
    ...
    const val ZXING_ANDROID_EMBEDDED = "4.1.0"
    ...
    const val ANDROID_IMAGE_CROPPER = "2.8.0"
    const val TOUCH_IMAGE_VIEW = "3.0.3"
    ...
    const val MEDIA2_SESSION = "1.1.2"

    const val MAPS_V3 = "3.1.0-beta"
    const val MAPS_UTILS_V3 = "2.2.0"
    const val MAPS_KTX = "2.2.0"
